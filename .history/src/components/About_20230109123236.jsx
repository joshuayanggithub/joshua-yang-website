...
const About = () => {
  return (
    <div class="h-screen py-10 px-5 flex items-center" style={{backgroundImage: "url(/imgs/snow_background.jpg)",  height: '100vh', width: "100vw", backgroundRepeat: "no-repeat",  backgroundPosition: 'left', backgroundSize: 'cover',}}>
      <h1 class="text-center py-10 px-8 my-3 mx-4 text-black font-pageheader font-bold text-8xl max-w-4xl">About Me</h1>
