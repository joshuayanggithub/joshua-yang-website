...
const NavBar = () => {
  ...
  return (
    <div class="md:flex bg-sasskyblue w-full justify-between items-center h-20 mx-auto px-4">
      ...
      <div class="fixed left-0 top-0 w-[40%] h-full border-r border-r-gray-600 bg-sasnavyblue">
        <h1 class="font-cursive text-5xl font-bold text-blue-200 m-4">Jy</h1>
        <ul class="">
            {
              links.map((link) => 
                <li key={link.id} class="p-4 border-b">
