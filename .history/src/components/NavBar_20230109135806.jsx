...
const NavBar = () => {
  ...
  return (
    <div class="fixed"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      ...
      <div class={!nav ? 'fixed left-0 top-0 w-[30%] h-full border-r bg-gray-400 bg-opacity-50 border-r-gray-600 ease-in-out duration-500' : "fixed  ease-in-out duration-500 left-[-100%] "}>
        <h1 class="font-navheader text-5xl font-bold text-black m-10">JY</h1>
        <ul class="p-4">
          {
            links.map((link) => 
