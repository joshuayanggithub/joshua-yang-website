...
const NavBar = () => {
  ...
  return (
    <div class="fixed flex"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      
      <div class="md:flex align-center my-0 mx-auto justify-between items-center w-full p-5 max-w-full">
