...
const NavBar = () => {
  ...
  return (
    <div class="md:flex flex-row bg-sasskyblue w-full justify-between items-center h-20 mr-auto px-4">
      ...
      <div class="hidden md:flex align-center my-0 justify-between items-center w-full p-5 max-w-6xl">
        <h1 class="font-navheader font-extrabold text-blue-900 text-3xl p-5">JYang. </h1>
        ...
        <ul class="hidden md:flex gap-10">
          {
            links.map((link) => 
              <li key={link.id} class="">
                <a href='#About' class="text-2xl text-white p-5 hover:bg-sasnavyblue hover:font-bold duration-300 font-navheader">{link.name}</a>
              </li>
            )
          }
        </ul>
