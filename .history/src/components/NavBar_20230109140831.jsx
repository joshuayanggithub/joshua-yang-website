...
const NavBar = () => {
  ...
  return (
    <div class="fixed w-screen flex items-center"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      ...
      <div class = "w-10" onClick={toggleNav}> {/* flex md:hidden*/}
