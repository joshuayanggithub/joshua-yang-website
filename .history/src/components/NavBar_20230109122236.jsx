...
const NavBar = () => {
  ...
  return (
    <div class="md:flex flex-row bg-transparent w-full justify-between items-center h-20 mr-auto">
      
      <div class="hidden md:flex align-center my-0 mx-auto justify-between items-center w-full p-5 max-w-6xl">
        <h1 class="font-pageheader font-bold text-white text-3xl p-5">Joshua Yang. </h1>
