...
const NavBar = () => {
  ...
  return (
    <div class="fixed flex justify-between"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      
      <div class="md:flex align-center my-0 mx-auto justify-between items-center w-sreen p-5">
