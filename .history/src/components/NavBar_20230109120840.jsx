  ...
  return (
    <div class="md:flex flex-row bg-sasskyblue w-full justify-between items-center h-20 mr-auto px-4">
      ...
      <div class="hidden md:flex items-center w-full">
        <img src="/imgs/logo-no-background.png" class="object-contain width-auto "></img> {/*rounded-full transition-shadow ease-in-out duration-300 shadow-none hover:shadow-2xl*/}
        <ul class="hidden md:flex gap-10 w-9/12">
          {
            links.map((link) => 
