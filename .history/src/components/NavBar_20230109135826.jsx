...
const NavBar = () => {
  ...
  return (
    <div class="fixed"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      ...
      <div class={!nav ? 'fixed left-0 top-0 w-[30%] h-full border-r bg-white bg-opacity-80 border-r-gray-600 ease-in-out duration-500' : "fixed  ease-in-out duration-500 left-[-100%] "}>
