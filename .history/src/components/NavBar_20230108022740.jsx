  ...
  return (
    <div class="md:flex bg-sasskyblue w-full justify-between items-center h-20 mx-auto px-4">
      ...
      <div onClick={toggleNav}>
        {nav ? <AiOutlineMenu size={50}></AiOutlineMenu> : <AiOutlineClose> size={30}</AiOutlineClose>}
      </div>
      ...
      <div class={!nav ? 'fixed left-0 top-0 w-[30%] h-full border-r border-r-gray-600 bg-sasnavyblue' ? "fixed hidden"}>
