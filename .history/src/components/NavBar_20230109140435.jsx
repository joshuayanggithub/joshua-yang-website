...
const NavBar = () => {
  ...
  return (
    <div class="fixed flex-row"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      ...
      <div class="md:flex align-center my-0 mx-auto justify-between items-center w-screen p-5">
        ...
        <div class="p-5 md:flex gap-8 items-center">
          <ul class="hideen left-[-100%] md:flex gap-10">
            {
              links.map((link) => 
          ...
          <div class = "flex" onClick={toggleNav}> {/* flex md:hidden*/}
