...
const About = () => {
  return (
    <div class="h-screen py-10 px-5 flex items-center" style={{backgroundImage: "url(/imgs/Sunset1.JPG)",  height: '100vh', width: "100vw", backgroundRepeat: "no-repeat",  backgroundPosition: 'left', backgroundSize: 'cover',}}>
