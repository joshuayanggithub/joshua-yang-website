...
const NavBar = () => {
  ...
  const menuButton = (
    <div class=""><AiOutlineMenu  size={50} ></AiOutlineMenu></div>
  )
  ...
  return (
    <div class="fixed"> {/*md:flex flex-row w-full justify-between items-center mx-auto */}
      ...
      <div class={!nav ? 'fixed left-0 top-0 w-[70%] h-full border-r border-r-gray-600 bg-white ease-in-out duration-500' : "fixed  ease-in-out duration-500 hidden "}>
