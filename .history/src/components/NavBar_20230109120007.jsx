  ...
  return (
    <div class="md:flex flex-row bg-sasskyblue w-full justify-between items-center h-20 mr-auto px-4">
      ...
      <div class={nav ? "hidden md:flex items-center" : 'hidden'}>
        <img src="/imgs/logo-no-background.png" class="object-contai h-auto w-auto rounded-full transition-shadow ease-in-out duration-300 shadow-none hover:shadow-2xl"></img>
