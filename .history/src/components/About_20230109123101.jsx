...
const About = () => {
  return (
    <div class="h-screen py-10 px-5 flex " style={{backgroundImage: "url(/imgs/snow_background.jpg)",  height: '100vh', width: "100vw", backgroundRepeat: "no-repeat",  backgroundPosition: 'left', backgroundSize: 'cover',}}>
