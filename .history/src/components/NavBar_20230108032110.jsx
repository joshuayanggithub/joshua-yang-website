...
const NavBar = () => {
  ...
  return (
    <div class="md:flex bg-sasskyblue w-full justify-between items-center h-20 mr-auto px-4">
      
      <div onClick={toggleNav} class="md:hidden">
        {nav ? <AiOutlineMenu> size="50px"</AiOutlineMenu>: null}
      </div>
      <div class={!nav ? 'hidden' : "hidden md:flex float-right items-center justify-between w-9/12"}>
