...
const About = () => {
  return  (
    <div id="About" class = "my-10 p-20 bg-slate-600" style={{backgroundImage: "url(/imgs/snow_background.jpg)",  height: '100vh', width: "100vw", backgroundRepeat: "no-repeat",  backgroundPosition: 'left', backgroundSize: 'cover',}}>
