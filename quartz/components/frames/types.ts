...
export interface PageFrame {
  ...
  css?: string
  /**
   * Render the frame output directly inside <body>, without the
   * #quartz-root/#quartz-body wrappers (only valid with enableSPA: false).
   */
  bare?: boolean
  /** Optional class attribute for <body>; a function lets it vary per page */
  bodyClass?: string | ((props: QuartzComponentProps) => string)
  /** Optional replacement for the default Head component */
  head?: (props: QuartzComponentProps) => JSX.Element
}
