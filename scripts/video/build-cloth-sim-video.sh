#!/bin/bash
# Builds quartz/static/site/media/demos/cloth-folding-sim.mp4: simulated cloth-folding trajectories
...
OUT="${OUT:-$HERE/../../quartz/static/site/media/demos/cloth-folding-sim.mp4}"
